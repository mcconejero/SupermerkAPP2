...
public class DashboardActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, ProductFragment.OnListFragmentInteractionListener, FavFragment.OnListFragmentInteractionListener {
    ...
    @Override
    public void onListFragmentInteraction(ProductResponse item) {
